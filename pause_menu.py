...
def pause():
    ...
    rect_position_y = resume_rect.top - 5
    frame_of_choice = pygame.Rect(resume_rect.left - 5, rect_position_y, resume_rect.width + 10, resume_rect.height + 10)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_DOWN and rect_position_y < main_menu_rect.top - 5:
                    rect_position_y += 100
                elif event.key == pygame.K_UP and rect_position_y > resume_rect.top + 5:
                    rect_position_y -= 100
